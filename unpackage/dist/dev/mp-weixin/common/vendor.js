...
//登录或者注册
exports.update_comment = update_comment;var user_center = function user_center(data) {
  return (0, _http.default)({
    url: 'user-center',
    data: data });
